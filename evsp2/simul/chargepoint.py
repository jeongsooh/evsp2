...
class ChargePoint(cp):
    ...
    # def on_reserve_now(self, args, **kwargs):
    ...
    def on_set_charging_profile(self, connector_id: int, cs_charging_profiles: str, **kwargs):
        ...
        if cs_charging_profiles['charging_profile_purpose'] == 'TxDeaultProfile' or cs_charging_profiles['charging_profile_purpose'] == 'TxProfile':
            status = 'Accepted'
        else:
            status = 'Rejected'
        logging.info('================================================')
